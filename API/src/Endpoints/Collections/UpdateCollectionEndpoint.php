...
namespace Timetabio\API\Endpoints\Collections
{
    ...
    class UpdateCollectionEndpoint extends AbstractEndpoint
    {
        ...
        public function hasAccess(AccessTypeInterface $accessType): bool
        {
            ...
            if ($accessType instanceof ScopedAccess) {
                return $accessType->hasScope('collections:write'); //todo: write or create for creating new collection?
            }
        ...
        {
            return $this->getFactory()->createUpdateCollectionController();
        }
    }
}

...
class ExtendedTime extends HTMLElement {
...
export class RelativeTimeElement extends ExtendedTime {
...
export class TimeAgoElement extends RelativeTimeElement {
  getFormattedDate () {
    if (this._date) {
...
export class TimeUntilElement extends RelativeTimeElement {
  getFormattedDate () {
    if (this._date) {
      var format = this.getAttribute('format');
      if (format === 'micro') {
...
export class LocalTimeElement extends ExtendedTime {
  constructor () {
    super()
